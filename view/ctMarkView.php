...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add CT Mark</li>
        </ol>
    </div>
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <?php while ($data = mysqli_fetch_assoc($info)) { ?>
                                        <tr>
                                            <?php for ($i = 1; $i < 6; $i++) {
                                                ...
                                                //echo '<td>' . '<a class="btn btn-success" href="edit_member.php?tablename='.$tbl_name.'&colname='.$cl_nm[$i].'&id='.$data['id'].'">Edit</a>' . '</td>';
                                             }
                                            ?>
                                            ...
                                            <?php //for ($i = 11; $i < $cl_nm_sz; $i++) {
                                               ...
                                               /* echo '<td><select class="form-control" name="check[]" required>
                                                ...
                                                echo '<td>' . '<a class="btn btn-success" href="addMark.php?tablename='.$tbl_name.'&id='.$data['id'].'">Edit</a>' . '</td>';
                                            //}
                                            ?>
